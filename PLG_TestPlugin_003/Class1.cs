...
namespace PLG_TestPlugin_003
{
    [Serializable]
    public class PLG_TestPlugin_003 : IPlugin
    {
        System.Timers.Timer counter;
        string _pluginName = "Plugin 003";
        int _timerInterval = 2000;
        bool _terminateRequestReceived;
        PluginStatus _Status = PluginStatus.Stopped;
        string _pluginID = "DCF1037F4-6B63-4A8A-AA8B-9BB95C4A675D";
        ...
        public bool Start()
        {
            DoCallback(new PluginEventArgs(PluginEventMessageType.Message, "003 Started"));
            RunProcess();
            return true;
        }
