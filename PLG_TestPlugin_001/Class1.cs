...
// plugin explanation
/*
 *  if this is a timer process ....
 *  ... RunProcess.... TerminateRequestReceived, IsRunning...Name, Version, Start, Stop, endProcess
 
 */
namespace PLG_TestPlugin_001
{
    [Serializable]
    public class PLG_TestPlugin_001 : IPlugin
    {
        System.Timers.Timer counter;
        string _pluginName = "Plugin 001";
